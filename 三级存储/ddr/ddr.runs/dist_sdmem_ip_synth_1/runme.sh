...
HD_PWD='C:/Users/agogow5/ddr/ddr.runs/dist_sdmem_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_sdmem_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_sdmem_ip.tcl
