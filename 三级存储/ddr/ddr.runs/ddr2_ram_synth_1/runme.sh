...
HD_PWD='C:/Users/agogow5/ddr/ddr.runs/ddr2_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr2_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr2_ram.tcl
