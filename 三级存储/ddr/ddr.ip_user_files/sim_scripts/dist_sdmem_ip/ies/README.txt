...
#
# Generated by export_simulation on Tue Dec 25 16:44:25 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './dist_sdmem_ip.sh' script.

./dist_sdmem_ip.sh -reset_run
...
./dist_sdmem_ip.sh -noclean_files

For more information on the script, please type './dist_sdmem_ip.sh -help'.
